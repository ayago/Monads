...
public class ReaderTest {
    ...
    private static final Function<String, Reader<SomeConfig, String>> f =
            fPrime -> Reader.unit(r -> r.envVariable.toString() + fPrime);

    private static final Function<String, Reader<SomeConfig, BigDecimal>> g =
            gPrime -> Reader.unit(r -> BigDecimal.valueOf(r.envVariable).add(new BigDecimal(gPrime)));
    ...
    public void leftIdentity(){
        ...
        Reader<SomeConfig, String> right = f.compose(given).apply(HYPOTHETICAL_CONFIG);
    ...
    public void rightIdentity(){
        ...
        Reader<SomeConfig, String> left = m.bind(s -> javaCompileHelper.apply(given));
